      ...
      <div class="product-card product-item" data-category="{{ $product->product_category }}">
         <a href="{{ route('products.show', ['product' => $product->product_id]) }}" class="product-link">
            <div class="product-image-container">
               @if($product->in_stock < 1) <div class="sold-out-overlay">
                  <span>SOLD OUT</span>
            </div>
            @endif
            {{--
            ...
            <img src="{{ storage_url($product->images->first()?->image_path) }}" alt="{{ $product->product_name }}">
            @else
   ...
   <div class="filter-panel" id="filter-panel">
      ...
      <div class="filter-body">
         <details class="filter-group" open>
            <summary>
               <span>Jewelries</span>
               <svg class="chevron-down" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
