...
<div class="profile-container">
    ...
    <div class="profile-header">
        ...
        <div class="avatar-edit-container">
            <div class="profile-avatar">
                ...
                <img src="{{ storage_url(Auth::user()->profilepic) }}" alt="{{ Auth::user()->name }}'s profile picture">
                @endif
            </div>
    ...
    <div class="profile-tabs">
        ...
        <button class="tab-link active" data-tab="order-processing">Order Processing
            ({{ $pendingOrders->count() }})</button>
    ...
    <div id="order-processing" class="tab-content {{ Auth::user()->shop ? 'active' : '' }}">
        ...
        <div class="order-card">
            <img src="{{ storage_url($item->product->images->first()?->image_path) }}" class="order-image">
