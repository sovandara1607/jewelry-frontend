...
<div class="profile-container">
    ...
    <div class="profile-header">
        <div class="avatar-edit-container">
            <div class="profile-avatar">
                ...
                <img src="{{ storage_url($shop->shop_profilepic) }}" alt="{{ $shop->shop_name }}'s logo">
                @endif
            </div>
            ...
            <div class="product-card">
                <a href="{{ route('products.show', $product->product_id) }}">
                    <div class="product-image-container">
                        <img src="{{ storage_url($product->images->first()?->image_path) }}"
    ...
    <div id="order-processing" class="tab-content">
        ...
        <div class="order-card">
            <img src="{{ storage_url($orderItem->product->images->first()?->image_path) }}" class="order-image">
