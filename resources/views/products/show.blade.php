   ...
   <div class="product-layout">
      <div class="image-gallery">
         <div class="thumbnail-list">
            ...
            <div class="thumbnail-item" data-src="{{ storage_url($image->image_path) }}">
               <img src="{{ storage_url($image->image_path) }}" alt="Thumbnail of {{ $product->product_name }}">
            </div>
            @endforeach
         </div>
         <div class="main-image-container">
            {{-- Display the first image by default, with a null-safe check --}}
            <img id="main-product-image" src="{{ storage_url($product->images->first()?->image_path) }}"
         ...
         <div class="product-title-header">
            ...
            <div class="product-actions-dropdown">
               ...
               <div class="kebab-menu">
                  <a href="{{ route('products.edit', $product->product_id) }}" class="kebab-item">Edit Listing</a>
         ...
         <a href="{{ route('shops.public', ['handle' => $seller->shop_name]) }}" class="seller-info-card-link">
            <div class="seller-info-card">
               <div class="seller-avatar">
                  ...
                  <img src="{{ storage_url($seller->shop_profilepic) }}" alt="{{ $seller->shop_name }}'s logo">
                  @endif
               </div>
