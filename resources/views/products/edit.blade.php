...
<div class="form-page-container">
   ...
   <div class="form-wrapper">
      ...
      @if(session('status'))
      <div
         style="background-color: #dfd; border: 1px solid #090; padding: 15px; margin-bottom: 20px; border-radius: 4px;">
      ...
      @if(session('warning'))
      <div
         style="background-color: #ffd; border: 1px solid #f90; padding: 15px; margin-bottom: 20px; border-radius: 4px;">
      ...
      @if ($errors->any())
      <div
         style="background-color: #fdd; border: 1px solid #f00; padding: 15px; margin-bottom: 20px; border-radius: 4px;">
      ...
      <form action="{{ route('products.update', $product->product_id) }}" method="POST" enctype="multipart/form-data">
         ...
         <div class="form-group">
            ...
            <textarea id="product_description" name="product_description" class="form-control"
               rows="5">{{ old('product_description', $product->product_description) }}</textarea>
         </div>
      ...
      <div> {{-- A simple wrapper for the whole section --}}
         ...
         <div class="form-group">
            ...
            <div class="current-images-grid">
               ...
               <div class="current-image-item">
                  <img src="{{ storage_url($image->image_path) }}" alt="Current product image">
                  <form
                     action="{{ route('products.images.delete', ['product' => $product->product_id, 'image' => $image->image_id]) }}"
         ...
         <div class="form-group">
            ...
            <form action="{{ route('products.images.add', $product->product_id) }}" method="POST"
