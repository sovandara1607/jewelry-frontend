   ...
   <div class="form-wrapper">
      ...
      <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
         ...
         <div class="form-group">
            ...
            <input type="number" id="price" name="product_price" class="form-control" placeholder="$ Price (USD)"
               step="0.01" min="0" required>
         </div>

         <div class="form-group">
            <label for="description" class="form-label">Product Description</label>
            <textarea id="description" name="product_description" class="form-control" rows="5"
               placeholder="Describe your item, materials used, dimensions, etc."></textarea>
         </div>
